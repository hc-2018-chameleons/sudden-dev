...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _playerlist = __webpack_require__(159);

	var _playerlist2 = _interopRequireDefault(_playerlist);

	var _addplayer = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/addplayer\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var store = (0, _store2.default)(initialStore);
...
/***/ (function(module, exports, __webpack_require__) {
	    ...
	    _createClass(PlayerList, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'ul',
	                null,
	                this.props.playerBar.map(function (player) {
	                    return _react2.default.createElement(
	                        'li',
	                        null,
	                        'player'
	...
	var VisiblePlayerList = (0, _reactRedux.connect)(mapStateToProps)(PlayerList);

	exports.default = VisiblePlayerList;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function configureStore(initialStore) {
	    var reducers = {
	        playerBar: _index2.default
	    };

	    var rootReducer = (0, _redux.combineReducers)(reducers);

	    return (0, _redux.createStore)(rootReducer, initialStore);
	}
...
/***/ (function(module, exports) {
	...
	function playerBar() {
	    ...
	    switch (action.type) {
	        case 'ADD_PLAYER':
	            Object.assign({}, state, {
	                players: [].concat(_toConsumableArray(state.players), [action.text])
	            });
	        case 'REMOVE_PLAYER':
	        default:
	            return state;
