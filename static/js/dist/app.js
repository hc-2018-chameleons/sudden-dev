...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _WebSockets = __webpack_require__(208);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var actions = _interopRequireWildcard(_WSClientActions);
	...
	function wsReducer() {
	  ...
	  switch (action.type) {
	    case actions.WS_CONNECT:
	      return [].concat(_toConsumableArray(state), [{ host: action.host }]);
...
/***/ (function(module, exports) {
	...
	var WS_CONNECTING = exports.WS_CONNECTING = "WS_CONNECTING";
	...
	var wsConnect = exports.wsConnect = function wsConnect(host) {
	  return { type: WS_CONNECT, host: host };
	};
	var wsConnecting = exports.wsConnecting = function wsConnecting(host) {
	  return { type: WS_CONNECTING, host: host };
	};
	var wsConnected = exports.wsConnected = function wsConnected(host) {
	  return { type: WS_CONNECTED, host: host };
	};
	var wsDisconnect = exports.wsDisconnect = function wsDisconnect(host) {
	  return { type: WS_DISCONNECT, host: host };
	};
	var wsDisconnected = exports.wsDisconnected = function wsDisconnected(host) {
	  return { type: WS_DISCONNECTED, host: host };
	};
...
/***/ (function(module, exports) {
	...
	var WS_HEALTH = exports.WS_HEALTH = "WS_HEALTH";

	var wsHealth = exports.wsHealth = function wsHealth(status) {
	  return { type: WS_HEALTH, status: status };
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ActivePlayerList = (0, _reactRedux.connect)(mapStateToProps, null)(PlayerList);
	                    ...
	                    this.props.test_case_inputs.map(function (data, i) {
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            { id: 'test-case', type: 'button', className: 'btn btn-primary', key: i, onClick: function onClick() {
	                                    return (0, _skulptRun2.default)(_this2.state.code, _this2.props.test_case_inputs, _this2.props.test_case_outputs);
	                                } },
	                            'Test case: ',
	                            i + 1
	                        );
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            { id: 'run-button', type: 'button', className: 'btn btn-danger', onClick: function onClick() {
	                                    return (0, _skulptRun2.default)(_this3.state.code, _this3.props.test_case_inputs, _this3.props.test_case_outputs);
	                                } },
	                            'Run'
	                        )
	                    ),
...
/***/ (function(module, exports) {
	...
	function runit(prog, test_inputs, expected_outputs) {
	    var tests_failed = 0;
	    var tests_passed = 0;
	    var test_failed_callback = function test_failed_callback() {
	        tests_failed++;
